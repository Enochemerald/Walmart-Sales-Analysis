...
> 3. Add a new column named `month_name` that contains the extracted months of the year on which the given transaction took place. This helps to determine whath month of the year has the most sales and profit.
